import { Quote, Star, ArrowRight,   Heart, Sparkles } from "lucide-react"
...
const testimonials: Testimonial[] = [
    ...
    {
        quote: "Outstanding web development services. Our website performance improved by 200% after their optimization.",
        author: "Ali Raza",
    ...
    {
        quote: "Their cloud migration service was flawless. Zero downtime and 50% cost reduction achieved.",
        author: "Maria Khan",
    ...
    {
        quote: "Best mobile app development team in Pakistan. Our app reached 10K downloads in the first month!",
        author: "Hassan Ali",
    ...
    {
        quote: "Digital marketing campaign exceeded our expectations. 400% increase in lead generation!",
        author: "Ayesha Malik",
    ...
    {
        quote: "Their desktop solutions streamlined our entire workflow. Productivity increased by 250%.",
        author: "Omar Sheikh",
    ...
    <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 border border-white/20 hover:shadow-2xl transition-all duration-500 group hover:-translate-y-1 min-w-[350px] mx-3 hover:bg-white/90">
        ...
        <div className="flex items-center space-x-3">
            ...
            <div className="flex-1">
                <div className="font-semibold text-[#0A1F44] text-sm">{testimonial.author}</div>
...
export default function ClientPromise() {
    return (
        <section className="min-h-screen py-20 relative overflow-hidden">
            ...
            <div className="absolute top-1/4 right-1/3 w-36 h-36 bg-white/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '0.5s' }} />
            ...
            <div className="w-full mx-auto relative z-10">
                ...
                <div className="text-center mb-16">
                    <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm rounded-full px-6 py-2 mb-8">
                        ...
                        <span className="text-sm font-semibold text-white">Our Promise</span>
                    </div>
                        ...
                        <div className="flex animate-scroll-left gap-0">
                            ...
                            {[...Array(3)].map((_, setIndex) => 
                                firstRowTestimonials.map((testimonial, index) => (
                                    <TestimonialCard key={`first-${setIndex}-${index}`} testimonial={testimonial} />
                                ))
                            )}
                        </div>
                    </div>
                        ...
                        <div className="flex animate-scroll-right gap-0">
                            ...
                            {[...Array(3)].map((_, setIndex) => 
                                secondRowTestimonials.map((testimonial, index) => (
                                    <TestimonialCard key={`second-${setIndex}-${index}`} testimonial={testimonial} />
                                ))
                            )}
                        </div>
                    </div>
                ...
                <div className="text-center">
                    <div className="inline-block bg-white/10 backdrop-blur-lg rounded-3xl p-12 text-white relative overflow-hidden shadow-2xl border border-white/20">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-r from-[#0A1F44]/20 to-[#8B0000]/20 rounded-3xl" />
                    </div>
                </div>
            </div>
