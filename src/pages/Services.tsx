...
export default function Services(): JSX.Element {
    useEffect(() => {
        // Set page title
        document.title = "Our Services - Web Development & Digital Solutions | CascadingXol"
        ...
        // Basic SEO Meta Tags
        setMetaTag('description', 'Explore CascadingXol\'s comprehensive services: custom web development, e-commerce solutions, mobile apps, AI automation, and digital transformation. 100+ successful projects delivered.')
        setMetaTag('keywords', 'web development services, digital solutions, e-commerce development, mobile app development, software services, AI automation, digital transformation, Pakistan')
        ...
        setMetaTag('og:title', 'Professional Web Development & Digital Solutions Services', true)
        setMetaTag('og:description', 'Custom web development, e-commerce platforms, mobile apps, and AI solutions. 5+ years experience, 100+ projects, 24/7 support.', true)
        setMetaTag('og:image', 'https://www.cascadingxol.com/images/services-og.jpg', true)
        ...
        setMetaTag('twitter:title', 'Professional Web Development & Digital Solutions')
        setMetaTag('twitter:description', 'Custom web development, e-commerce, mobile apps & AI solutions. 100+ successful projects with 24/7 support.')
        setMetaTag('twitter:image', 'https://www.cascadingxol.com/images/services-twitter.jpg')
        ...
        const structuredData = {
            ...
            "description": "Comprehensive web development, mobile app development, e-commerce solutions, and digital transformation services",
            "hasOfferCatalog": {
                "@type": "OfferCatalog",
    ...
    return (
        <div className="flex flex-col">
            ...
            {/* Services Grid */}
            <section className="py-20 bg-gradient-to-b from-white to-gray-50/50 relative overflow-hidden" aria-label="Our services portfolio" id="services-portfolio">
                {/* Background Elements */}
                ...
                <div className="container mx-auto px-6 relative">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16" itemScope itemType="https://schema.org/ItemList">
                        {services.map((service, index) => (
                            <div key={index} itemScope itemType="https://schema.org/Service" itemProp="itemListElement">
                                <ServiceCard
                                    icon={service.icon}
                                    title={service.title}
                                    desc={service.desc}
            ...
            {/* Our Process */}
            <section className="py-20 bg-white" aria-label="Our development process" id="our-process">
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {processSteps.map((step, index) => (
                            <article key={index} className="relative group" itemScope itemType="https://schema.org/HowToStep">
                                <div className="text-center">
                                    ...
                                    <h3 className="text-xl font-bold text-[#0A1F44] mb-3" itemProp="name">
                                        {step.title}
                                    </h3>
                                ...
                                {index < processSteps.length - 1 && (
                                    <div className="hidden lg:block absolute top-10 left-full w-full h-0.5 bg-gradient-to-r from-[#0A1F44]/30 to-[#8B0000]/30 transform translate-x-4" aria-hidden="true" />
                                )}
                            </article>
                        ))}
                    </div>
            ...
            {/* Why Choose Us */}
            <section className="py-20 bg-gray-50" aria-label="Why choose us" id="why-choose-us">
                <div className="container mx-auto px-6">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="relative">
                            ...
                            {/* Floating Stats Card */}
                            <div className="absolute -bottom-6 -left-6 bg-white rounded-xl p-4 shadow-xl border" role="complementary" aria-label="Success statistics">
            ...
            {/* Client Testimonials */}
            <section className="py-20 bg-white" aria-label="Client testimonials" id="testimonials">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold text-[#0A1F44] mb-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {testimonials.map((testimonial, index) => (
                            <article key={index} className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100" itemScope itemType="https://schema.org/Review">
                                {/* Rating Stars */}
                                <div className="flex space-x-1 mb-4" itemProp="reviewRating" itemScope itemType="https://schema.org/Rating">
                                ...
                                {/* Quote */}
                                <blockquote className="text-gray-700 mb-6 italic leading-relaxed" itemProp="reviewBody">
                                    "{testimonial.quote}"
                                </blockquote>

                                {/* Author */}
                                <div className="border-t border-gray-200 pt-4" itemProp="author" itemScope itemType="https://schema.org/Person">
                                    <div className="font-semibold text-[#0A1F44]" itemProp="name">{testimonial.author}</div>
                                    <div className="text-sm text-gray-600 mb-2" itemProp="jobTitle">{testimonial.position}</div>
                                    <div className="inline-block px-3 py-1 bg-[#8B0000]/10 text-[#8B0000] text-xs font-medium rounded-full" itemProp="itemReviewed" itemScope itemType="https://schema.org/Service">
